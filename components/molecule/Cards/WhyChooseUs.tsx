  ...
  return (
    <>
      <div className="max-w-[395px] flex flex-col gap-[10px]  cursor-pointer rounded-[20px] p-[10px] border border-border_color">
        ...
        {/* heading test */}
        <div>
          <Text variant="body">State of the Art Technology</Text>
        </div>

        {/* paragraph */}
        <div>
          <Text
            className="text-secondary_foreground line-clamp-2 flex-1"
            variant="span"
          >
            We use the latest equipment and techniques for precise and effective
            treatments.
          </Text>
        </div>
        {/* numbering */}
